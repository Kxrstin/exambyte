...
public class StudiTestRepoImpl implements StudiTestRepo {
    ...
    public StudiTestRepoImpl() {
        TestForm testForm1 = new TestForm("Programmierpraktikum 2 Test Woche 4", LocalDate.of(2024, 12, 1), LocalDate.of(2024, 12, 22), LocalDate.of(2025, 1, 2), 1);
        TestForm testForm2 = new TestForm("Mathematik für Informatik 3 Test Woche 5", LocalDate.of(2024, 12, 3), LocalDate.of(2024, 12, 18), LocalDate.of(2025, 1, 1), 2);
        TestForm testForm3 = new TestForm("Algorithmen und Datenstrukturen Test Woche 5", LocalDate.of(2024, 12, 2), LocalDate.of(2024, 12, 3), LocalDate.of(2025, 1, 1), 3);
